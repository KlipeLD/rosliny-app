    ...
    <form method="POST" action="{{ route('plants.update', $plant) }}" enctype="multipart/form-data" class="card p-4">
            ...
            <div class="row g-2 mb-2">
                <div class="col-sm-6">
                    ...
                    <input
                        ...
                        value="{{ old('soil_moisture_min', $plant->soil_moisture_min) }}"
                        class="form-control @error('soil_moisture_min') is-invalid @enderror"
                    >
                </div>
                <div class="col-sm-6">
                    ...
                    <input
                        ...
                        value="{{ old('soil_moisture_max', $plant->soil_moisture_max) }}"
                        class="form-control @error('soil_moisture_max') is-invalid @enderror"
                    >
                </div>
            </div>
            ...
            <div class="row g-2">
                <div class="col-sm-6">
                    ...
                    <input
                        ...
                        min="0"
                        max="100"
                        name="soil_moisture_ideal_min"
                        value="{{ old('soil_moisture_ideal_min', $plant->soil_moisture_ideal_min) }}"
                        class="form-control @error('soil_moisture_ideal_min') is-invalid @enderror"
                    >
                </div>
                <div class="col-sm-6">
                    ...
                    <input
                        ...
                        min="0"
                        max="100"
                        name="soil_moisture_ideal_max"
                        value="{{ old('soil_moisture_ideal_max', $plant->soil_moisture_ideal_max) }}"
                        class="form-control @error('soil_moisture_ideal_max') is-invalid @enderror"
                    >
                </div>
            </div>

            @error('soil_moisture_min')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
            @error('soil_moisture_max')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
            @error('soil_moisture_ideal_min')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
            @error('soil_moisture_ideal_max')
                <div class="invalid-feedback d-block">{{ $message }}</div>
            @enderror
        </div>
        ...
        <div class="mb-4">
            ...
            <input
                ...
                value="{{ old('watering_interval_days', $plant->watering_interval_days) }}"
                class="form-control @error('watering_interval_days') is-invalid @enderror"
            >
            <div class="small text-muted mt-1">
                Gdy pole jest puste, termin podlewania będzie liczony z historii pomiarów.
            </div>
